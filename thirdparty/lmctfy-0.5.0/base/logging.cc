...
// Removed the following macros to break dependency on Gflags
...
static int32 FLAGS_minloglevel = LOGLEVEL_INFO;
static int32 FLAGS_stderrthreshold = LOGLEVEL_ERROR;
